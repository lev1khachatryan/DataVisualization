...
--DECLARE @DIFFERENCE AS INT = @CURRENTMONTH +9

--DECLARE @MONTH AS INT = @CURRENTMONTH - 2
...
--DECLARE @DIFFERENCE AS INT = @CURRENTMONTH +10

--DECLARE @MONTH AS INT = @CURRENTMONTH - 2
--DECLARE @DATE AS INT = 390
...
DECLARE @DIFFERENCE AS INT = 4

DECLARE @MONTH AS INT = 1
DECLARE @DATE AS INT = 90
